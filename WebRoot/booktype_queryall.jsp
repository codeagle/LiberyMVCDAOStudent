...
<%
	...
	%> 
  <tr>
   <td style="padding:5px;"><%=booktype.getTypeid()%></td>
    <td style="padding:5px;"><%=booktype.getTypename()%></td>
    <td align="center"><a href="BookTypeFindByIdServlet?typeid=<%=booktype.getTypeid()%>" >修改</a></td>
    <td align="center"><a href="BookTypeDeleteServlet?typeid=<%=booktype.getTypeid() %>" >删除</a></td> 
  </tr>
<%
 }}
%>  
